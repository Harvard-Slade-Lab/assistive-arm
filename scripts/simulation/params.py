...
PARAMS = {
    ...
    'control_effort_weight': 0.001,  # W_C, Global penalization

    # --- Control Effort Parameters --- # 
    'coord_actuator_opt_value': 250,  # Nm for coordinate actuators: lumbar, arms
    'reserve_actuator_opt_value': 10,  # N for reserve actuators: pelvis, legs, feet
    ...
    'control_effort_muscles': 20,  # Set to 1 if assisted, otherwise 20
    'reserve_feet_weight': 1,
    'reserve_knee_weight': 5,
    'reserve_hip_weight': 5, 
    'reserve_pelvis_weight': 15, # higher means more penalty (minimizing)
    'reserve_pelvis_weight_txy': 0, # higher means more penalty (minimizing)

    # Assistance hyperparameters
    'assist_with_reserve_pelvis_txy': True,
    'reserve_pelvis_tx_ty_opt_value': 700,
