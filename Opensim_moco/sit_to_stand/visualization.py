...
# ========== Session parameters ==========
date = "20250605_165441"
subj = "S002"
task = "sit_to_stand_4"
body_weight = 70 * 9.81 # N
...
ref_m_activation_path = f'./reference_muscle_activation/sit_to_stand_Nathan_thesis'
...
if plot_muscle_activation_flag:
    plot_muscle_activation_grid(df_sim=df_sim_sol, ref_m_activation= ref_m_activation_path,  fontsize=8, figsize=(8, 4), fig_path=sim_path)

if plot_osim_grf_flag:
    plot_GRF_osim_v2(df_sim_floor=df_grf_floor, df_sim_chair=df_grf_chair, body_weight = body_weight, fontsize=8, figsize=(8, 2), fig_path=sim_path)

if plot_residual_force_torque_flag:
    if sim_params['robot_assistance']:
        plot_assistive_force(df_sim=df_sim_sol, sim_params= sim_params, fontsize=8, figsize=(4, 2), fig_path=sim_path)
